...
exports.TurfOwnerValidations = void 0;
const zod_1 = require("zod");
const createTurfOwnerSchema = zod_1.z.object({
    body: zod_1.z.object({
...
const updateTurfOwnerSchema = zod_1.z.object({
    body: zod_1.z.object({
...
exports.TurfOwnerValidations = {
    createTurfOwnerSchema,
    updateTurfOwnerSchema,
};
