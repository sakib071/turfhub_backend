...
SuperAdminSchema.statics.isSuperAdminExists = function (id) {
    return __awaiter(this, void 0, void 0, function* () {
        const existingUser = yield exports.SuperAdmin.findById({ _id: id });
        return existingUser;
    });
};
exports.SuperAdmin = (0, mongoose_1.model)('SuperAdmins', SuperAdminSchema);
